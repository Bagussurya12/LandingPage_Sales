        ...
        <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-10">
          ...
          >
            <img
              ...
              alt="Virginia-pine"
              class="product w-full h-64 object-cover transition-opacity duration-300 hover:opacity-80"
            />
            <!-- TEXT PRODUCT -->
            <div class="p-4 bg-white bg-opacity-90 backdrop-blur-md">
              <div class="text-center py-4 px-6">
                ...
                <p class="font-medium font-serif text-base text-gray-900 mb-4">
                  Unit di cluster ke-2 dengan desain fasad modern minimalis ini
                  hanya tinggal beberapa unit tersisa! Jangan sampai kehabisan,
          ...
          >
            ...
            <div class="p-4 bg-white bg-opacity-90 backdrop-blur-md">
              <div class="text-center py-4 px-6">
                ...
                <p class="font-medium font-serif text-base text-gray-900 mb-9">
                  Unit di cluster ke-3 Northern Pine ini baru saja membuka blok
                  baru. Dapatkan penawaran terbaiknya sebelum harga naik!
                </p>
                <a
                  href="#"
                  class="font-medium text-sm bg-Hijau py-2 px-4 rounded-lg hover:bg-teal-900 text-white"
...
/* Tambahkan gaya untuk memastikan gambar memiliki ukuran yang sama */
.product {
  width: 100%; /* Lebar penuh */
  height: 22rem; /* Menetapkan tinggi gambar */
  object-fit: cover; /* Memastikan gambar memotong atau menyesuaikan dengan kontainer */
}
</style>
