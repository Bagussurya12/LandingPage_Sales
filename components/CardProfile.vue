      ...
      <div class="w-full">
        <div class="flex justify-center">
          <div class="w-full md:flex md:items-center bg-gray-100 py-20">
            <div class="md:w-2/5 md:order-first">
              <div
            ...
            <div class="md:w-3/5 mx-16 mb-10">
              <div
                class="uppercase tracking-wide text-4xl md:text:2xl text-Dark font-semibold mb-2 ml-4"
              >
                {{ profile.fullName }}
              </div>
              <div
              ...
              <p
                class="text-lg leading-relaxed text-Dark mb-6 ml-4 max-w-[600px]"
              >
                {{ profile.bio }}
              </p>
              <div class="mt-4 ml-4">
                ...
                <div class="flex flex-wrap">
                  <a
                    href="`https://wa.me/${profile.socialmedia.tiktok}`"
                    target="_blank"
